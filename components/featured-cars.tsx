      ...
      {cars.map((car) => (
        ...
        >
          ...
          <div className="relative w-full aspect-[4/3] overflow-hidden">
            ...
            {/* Featured Tag */}
            <Badge className="absolute top-3 sm:top-4 right-3 sm:right-4 bg-gradient-to-r from-gray-700 to-gray-800 text-gray-100 px-3 sm:px-4 py-1 sm:py-1.5 text-xs sm:text-sm font-medium backdrop-blur-sm border border-gray-600/30 shadow-lg transform group-hover:scale-105 transition-transform duration-300">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  <div className="p-1.5 sm:p-2 bg-gray-700/20 rounded-lg backdrop-blur-sm">
                    <Car className="w-3 h-3 sm:w-4 sm:h-4 text-gray-200" />
                  </div>
                  <span className="text-xs sm:text-sm text-white font-medium">{car.type}</span>
                </div>
                <div className="flex items-center space-x-2">
                  <div className="p-1.5 sm:p-2 bg-gray-700/20 rounded-lg backdrop-blur-sm">
                    <Fuel className="w-3 h-3 sm:w-4 sm:h-4 text-gray-200" />
                  </div>
          ...
          <div className="p-4 sm:p-6">
            ...
            <Button 
              asChild
              variant="outline" 
              className="w-full border-2 border-gray-300 hover:border-gray-400 hover:text-gray-800 text-gray-700 font-medium transition-all duration-300 hover:bg-gray-200/50 group-hover:shadow-md text-sm sm:text-base shadow-sm"
            >
